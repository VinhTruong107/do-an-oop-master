...
public class UserManager {
   ...
   // private Scanner scanner = new Scanner(System.in); // Khởi tạo scanner để nhập dữ liệu từ người dùng
    ...
    //     userList.add(user);
    //     System.out.println("Người dùng đã được thêm: " + user.getUsername());
    // }

    // public void addManager(Manager manager) {
    //     managerList.add(manager);
    //     System.out.println("Quản lý đã được thêm: " + manager.getUsername());
    // }
    ...
    //             user.displayUser(); // Assuming displayUser() prints user details
    //             found = true;
    //         }
    //     }
    //     if (!found) {
