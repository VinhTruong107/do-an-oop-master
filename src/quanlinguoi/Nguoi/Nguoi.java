...
public abstract class Nguoi implements Serializable {
    ...
    // public abstract void performAction();
        ...
        // Các phương thức trừu tượng để được triển khai trong các lớp con
        public abstract void performAction();
        public abstract void addPurchase(String product); // Thêm vào lịch sử mua hàng
        public abstract void viewPurchaseHistory(); // Xem lịch sử mua hàng
